        ...
        <div className={`section section-padding-t90-b100 ${classOption}`}>
            <div className="container shape-animate">
                <SectionTitle
                    ...
                    title="We are a full-service consulting business"
                    subTitle="Providing comprehensive solutions tailored to meet your unique business needs, from strategy to execution."
                />
